  ...
  return (
    ...
    >
      ...
      <div className="flex items-center justify-between px-6 py-3 bg-black/90 border border-amber-50 text-white rounded-full shadow-lg backdrop-blur-sm">
        ...
        {/* Mobile Navbar */}
        <div className="md:hidden flex items-center w-full justify-center relative">
          {/* Hamburger button with absolute positioning on the left */}
